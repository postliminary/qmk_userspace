...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_tsangan_hhkb(
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, ___X___,
    ...
    [_FN] = LAYOUT_60_tsangan_hhkb(
        ...
        _______,          ___X___, ___X___, KC_CAPS, ___X___, ___X___, ___X___, ___X___, KC_MPRV, KC_MNXT, KC_MPLY, _______, ___X___,
    ...
    [_KBFN] = LAYOUT_60_tsangan_hhkb(
        ...
        _______,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, ___X___,
